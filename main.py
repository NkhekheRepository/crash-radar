...
from src.data_ingestion.direct_fetcher import run_direct_fetch
...
def run_pipeline(fetch_data: bool = False):
    ...
    try:
        ...
        if fetch_data:
            logger.info("Phase 0: Fetching data from APIs...")
            run_direct_fetch()
        
        logger.info("Phase 1: Validating data sync...")
...
def main():
    ...
    if args.once or args.fetch:
        run_pipeline(fetch_data=args.fetch)
        return
